...
const vcard = 'BEGIN:VCARD\n' 
            + 'VERSION:3.0\n' 
            + 'FN:TRI-Xploit™ Admin\n' 
            + 'ORG: Pengembang BOT JZE-Xploit™;\n' 
            + 'TEL;type=CELL;type=VOICE;waid=6283140691740:+62 831-4069-1740\n' 
            + 'END:VCARD' 
blocked = []   
prefix = '#'
limitawal = 30
...
/******** OWNER NUMBER**********/
const ownerNumber = ["6283140691740@s.whatsapp.net","6283140691740@s.whatsapp.net"] 
/************************************/
